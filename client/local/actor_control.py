...
class CharacterControl:
    ...
    def move_forward(self, task):
        ...
        core.instance.messenger.send(event=Event.CLIENT_STARTED_CHANGING_POS_HPR, sentArgs=[self.character])
        return Task.cont
    ...
    def rotate_left(self, task):
        self.character.set_h(self.character, self.movement_speed * 80 * globalClock.getDt())
        return Task.cont
