...
class ObjectPicking:
    def __init__(self, skirmish):
        ...
        self.picker_node_path = self.core.camera.attach_new_node(self.picker_node)
    ...
    def find_pickable(self):
        if self.core.mouseWatcherNode.has_mouse():
            mouse_pos = self.core.mouseWatcherNode.get_mouse()
            self.picker_ray.set_from_lens(self.core.camNode, mouse_pos.get_x(), mouse_pos.get_y())
