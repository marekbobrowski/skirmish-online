...
class InputHandling:
    ...
    def q_handler(self):
        if self.skirmish.player.target is not None:
            self.skirmish.cooldowns.trigger_cooldown(0)
    ...
    def e_handler(self):
        if self.skirmish.player.target is not None:
            self.skirmish.cooldowns.trigger_cooldown(1)
